...
#: is the other, and ADR-0043 §1 is the argument between them) -- while
...
class SourceGateRegistry:
    ...
    **The rate is one value for every source**, deliberately: issue #19 asks
    whether the ceiling belongs per source and ADR-0043 answers *"yes for the
