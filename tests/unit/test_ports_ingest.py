...
def test_a_match_outcome_records_how_as_well_as_what() -> None:
    """PRD 10's `usher.match.result` counter is labelled by method.

    An outcome that carried only a title id would make "which tier is actually earning
    its keep" unanswerable.
    """
