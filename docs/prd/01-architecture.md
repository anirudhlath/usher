...
|---|---|
| the configured media source (`emby/session.py`) | the per-source minimum-interval gate, `USHER_SOURCE_REQUESTS_PER_SECOND` ([ADR-0043](decisions/0043-the-outbound-limiter-is-per-source-and-spaces-requests.md)) |
