...
| [0041](0041-a-bounded-column-is-a-declared-type-that-refuses.md) | A bounded column is a declared type that refuses, the per-column ledger is generated rather than quoted, and M10 fixes the 21 that reach a translatable exception | Accepted — issue #10's scoped decision; corrects PRD 09's carried-debt arithmetic. **Does not re-open M9's boundary call 8** |
